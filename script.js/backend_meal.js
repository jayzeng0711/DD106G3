...
$(document).on('click', '.edit', function(){
    $('.edit').click(function(){
        ...
        <form id="mealPic" class="mealPic" action="./php/picPreview.php"><input type="file" class="mealPic" name="mealPic" accept=".jpg,.png,.svg" value="${mealPic}"><img id="preview" src=""><button id="preview" type="submit">上傳</button></form>`);
...
window.addEventListener('load', function(){
    document.getElementsByName('mealPic').onchange = function(e){
