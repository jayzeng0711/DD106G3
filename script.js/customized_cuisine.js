window.addEventListener("load", function() {
    ...
    let dafault = [{
        ...
        "name": "胭脂蝦",
        "price": "1200",
        "img": "./images/seafood6.svg"
    }, {
        "name": "毛蟹",
        "price": "1400",
        "img": "./images/seafood7.svg"
    }];

    // 就存入預設海鮮
    localStorage["dafaultfish"] = JSON.stringify(dafault);
    ...
    if (localStorage["fish"] == undefined) {
        // 預設的海鮮
        fish = JSON.parse(localStorage["dafaultfish"]);
    } else {
        // 遊戲抓到的海鮮
        fish = JSON.parse(localStorage["fish"]);
    }
