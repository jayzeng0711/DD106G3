...
try{
    ...
    $sql = "Update `meal` set `mealPic`='1', `mealFirst`=:mealFirst, `mealMain`=:mealMain, `mealDishOne`=:mealDishOne, `mealDishTwo`=:mealDishTwo, `mealSoup`=:mealSoup, `mealDrink`=:mealDrink, `mealPrice`=:mealPrice, `mealState`=:mealState where `mealNo`=:mealNo";
    ...
    $editmeal->bindValue(':mealState', $mealRows->meatState);
    $editmeal->execute();
